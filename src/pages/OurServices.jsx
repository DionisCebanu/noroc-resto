      ...
      const services = [
        {
          ...
          imageSrc: '/images/services/wedding-pair.png',
        ...
        },
        {
          ...
          imageSrc: '/images/services/anniversary.png',
        ...
        },
        {
          ...
          imageSrc: '/images/services/cumatrie.png',
        ...
        >
          ...
          >
            ...
            <p className="mt-4 text-lg sm:text-xl text-slate-300 max-w-2xl mx-auto">
              {t('ourServicesMainSubtitle', { defaultText: "At The Norok, we specialize in turning your special occasions into cherished memories. Explore our tailored services designed for elegance, joy, and unforgettable culinary experiences." })}
            </p>
          </motion.div>
                ...
                <Card className="w-full flex flex-col bg-slate-800/70 border-slate-700 shadow-xl hover:shadow-primary/30 transition-all duration-300 transform hover:-translate-y-1.5 group">
                  <div className="relative h-64 w-full overflow-hidden rounded-t-lg">
                    <img   
                      ...
                      className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" src={service.imageSrc}  />
                  </div>
